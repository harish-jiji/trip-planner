                                        ...
                                        {loc.link && (
                                            <div className="mt-3">
                                                <a
                                                    ...
                                                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-lg text-xs font-bold transition-all hover:bg-blue-100 dark:hover:bg-blue-900/60 border border-blue-100 dark:border-blue-800"
                                                    onClick={(e) => e.stopPropagation()}
                                                >
                                                    <span className="text-sm">🔗</span> View Social / Attraction Page
                                                </a>
                                            </div>
                                        )}
